...
from .backbone_prompt import BackbonePrompt

class CompletionFormerPrompt(nn.Module):
    def __init__(self, args):
        super(CompletionFormerPrompt, self).__init__()

        self.args = args

        self.prop_time = self.args.prop_time
        self.num_neighbors = self.args.prop_kernel*self.args.prop_kernel - 1
        self.backbone = BackbonePrompt(args, mode='rgbd')
