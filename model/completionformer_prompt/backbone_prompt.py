...
from .pvt_prompt import PVTPrompt
...
class BackbonePrompt(nn.Module):
    def __init__(self, args, mode='rgbd'):
        super(BackbonePrompt, self).__init__()
        self.args = args
        self.mode = mode
        ...
        self.former = PVTPrompt(in_chans=64, patch_size=2, pretrained='./model/completionformer_original/pretrained/pvt.pth')
