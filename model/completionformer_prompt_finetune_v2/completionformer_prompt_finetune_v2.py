...
from .backbone_prompt_finetune_v2 import BackbonePromptFinetuneV2

class CompletionFormerPromptFinetuneV2(nn.Module):
    def __init__(self, args):
        super(CompletionFormerPromptFinetuneV2, self).__init__()
        ...
        self.backbone = BackbonePromptFinetuneV2(args, self.foundation.backbone, mode='rgbd')
