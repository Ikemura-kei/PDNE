...
from .pvt_late_fusion import PVTLateFusion
...
class BackboneLateFusion(nn.Module):
    def __init__(self, args, foundation, mode='rgbd'):
        super(BackboneLateFusion, self).__init__()
        self.args = args
        self.mode = mode
        ...
        self.former = PVTLateFusion(in_chans=64, patch_size=2, pretrained='./model/completionformer_original/pretrained/pvt.pth', foundation=foundation.former)
