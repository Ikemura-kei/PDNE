...
from .backbone_late_fusion import BackboneLateFusion
from .backbone_late_fusion import conv_bn_relu

class CompletionFormerLateFusion(nn.Module):
    def __init__(self, args):
        super(CompletionFormerLateFusion, self).__init__()
        ...
        self.backbone = BackboneLateFusion(args, self.foundation.backbone, mode='rgbd')

        self.conv_pol = conv_bn_relu(4, 4, kernel=1, stride=1, padding=0,
                                          bn=False)
