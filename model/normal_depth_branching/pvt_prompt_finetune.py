...
class PyramidVisionTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
        ...
        # print(self.embed_layer1)
        # print("---------")
        # print(self.embed_layer2)
        # print(torch.any(torch.isnan(self.embed_layer1.parameters())))
        # print(torch.any(torch.isnan(self.embed_layer2.parameters())))
        # exit()
        in_chans = 128
