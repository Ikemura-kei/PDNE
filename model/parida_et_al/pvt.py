...
class PVT(PyramidVisionTransformer):
    def __init__(self, in_chans, patch_size=4, num_stages=4, **kwargs):
        super(PVT, self).__init__(
            ...
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), num_stages=num_stages, depths=[3, 4, 6, 3],
