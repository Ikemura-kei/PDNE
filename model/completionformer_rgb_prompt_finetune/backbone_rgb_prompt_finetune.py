...
from .pvt_rgb_prompt_finetune import PVTRGBPromptFinetune
...
class BackboneRGBPromptFinetune(nn.Module):
    def __init__(self, args, foundation, mode='rgbd'):
        super(BackboneRGBPromptFinetune, self).__init__()
        self.args = args
        self.mode = mode
        ...
        self.former = PVTRGBPromptFinetune(in_chans=64, patch_size=2, pretrained='./model/completionformer_original/pretrained/pvt.pth', foundation=foundation.former)
    ...
    def forward(self, rgb=None, depth=None):
        ...
        if self.mode == 'rgbd':
            ...
            fe1_prompt_for_rgb = self.prompt

            fe1_rgb = fe1_rgb + fe1_prompt_for_rgb
