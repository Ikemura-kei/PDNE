...
from .backbone_rgb_prompt_finetune import BackboneRGBPromptFinetune

class CompletionFormerRGBPromptFinetune(nn.Module):
    def __init__(self, args):
        super(CompletionFormerRGBPromptFinetune, self).__init__()
        ...
        self.backbone = BackboneRGBPromptFinetune(args, self.foundation.backbone, mode='rgbd')
