...
python main.py --dir_data /root/autodl-tmp/yiming/datasets/polar_hammer \
                ...
                # --resume --pretrain /root/autodl-tmp/yiming/ikemura_ws/PDNE_PROMT_FINETUNE/PDNE/experiments/231021_183151_model-12/model_00090.pt
